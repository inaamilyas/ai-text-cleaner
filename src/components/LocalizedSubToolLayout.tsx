...
export function generateSubToolMetadata(langCode: string, subToolKey: keyof typeof LANGUAGES['en']['subtools'], pathSlug: string) {
  ...
  return {
    ...
    alternates: {
      canonical: langCode === 'en' ? `https://text-cleaner-ai.com/${pathSlug}` : `https://text-cleaner-ai.com/${langCode}/${pathSlug}`,
      languages: {
        en: `https://text-cleaner-ai.com/${pathSlug}`,
        es: `https://text-cleaner-ai.com/es/${pathSlug}`,
        de: `https://text-cleaner-ai.com/de/${pathSlug}`,
        fr: `https://text-cleaner-ai.com/fr/${pathSlug}`,
        it: `https://text-cleaner-ai.com/it/${pathSlug}`,
        pt: `https://text-cleaner-ai.com/pt/${pathSlug}`,
        ar: `https://text-cleaner-ai.com/ar/${pathSlug}`,
        ja: `https://text-cleaner-ai.com/ja/${pathSlug}`,
        nl: `https://text-cleaner-ai.com/nl/${pathSlug}`,
        tr: `https://text-cleaner-ai.com/tr/${pathSlug}`,
        id: `https://text-cleaner-ai.com/id/${pathSlug}`,
      },
    },
    openGraph: {
      title: toolData.title,
      description: toolData.description,
      url: langCode === 'en' ? `https://text-cleaner-ai.com/${pathSlug}` : `https://text-cleaner-ai.com/${langCode}/${pathSlug}`,
      locale: langCode,
      type: 'website',
    },
  };
...
export default function LocalizedSubToolLayout({
  ...
  const webAppJsonLd = {
    ...
    url: langCode === 'en' ? 'https://text-cleaner-ai.com' : `https://text-cleaner-ai.com/${langCode}`,
    description: toolData.description,
