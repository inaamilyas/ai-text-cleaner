...
export function generateSubToolMetadata(langCode: string, subToolKey: keyof typeof LANGUAGES['en']['subtools'], pathSlug: string) {
  ...
  return {
    ...
    alternates: {
      canonical: langCode === 'en' ? `https://text-clean-ai.com/${pathSlug}` : `https://text-clean-ai.com/${langCode}/${pathSlug}`,
      languages: {
        en: `https://text-clean-ai.com/${pathSlug}`,
        es: `https://text-clean-ai.com/es/${pathSlug}`,
        de: `https://text-clean-ai.com/de/${pathSlug}`,
        fr: `https://text-clean-ai.com/fr/${pathSlug}`,
        it: `https://text-clean-ai.com/it/${pathSlug}`,
        pt: `https://text-clean-ai.com/pt/${pathSlug}`,
        ar: `https://text-clean-ai.com/ar/${pathSlug}`,
        ja: `https://text-clean-ai.com/ja/${pathSlug}`,
        nl: `https://text-clean-ai.com/nl/${pathSlug}`,
        tr: `https://text-clean-ai.com/tr/${pathSlug}`,
        id: `https://text-clean-ai.com/id/${pathSlug}`,
      },
    },
    openGraph: {
      title: toolData.title,
      description: toolData.description,
      url: langCode === 'en' ? `https://text-clean-ai.com/${pathSlug}` : `https://text-clean-ai.com/${langCode}/${pathSlug}`,
      locale: langCode,
      type: 'website',
    },
  };
...
export default function LocalizedSubToolLayout({
  ...
  const webAppJsonLd = {
    ...
    url: langCode === 'en' ? 'https://text-clean-ai.com' : `https://text-clean-ai.com/${langCode}`,
    description: toolData.description,
