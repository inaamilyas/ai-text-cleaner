...
export function generateLocalizedMetadata(langCode: string) {
  ...
  return {
    ...
    alternates: {
      canonical: langCode === 'en' ? 'https://text-clean-ai.com' : `https://text-clean-ai.com/${langCode}`,
      languages: {
        en: 'https://text-clean-ai.com',
        es: 'https://text-clean-ai.com/es',
        de: 'https://text-clean-ai.com/de',
        fr: 'https://text-clean-ai.com/fr',
        it: 'https://text-clean-ai.com/it',
        pt: 'https://text-clean-ai.com/pt',
        ar: 'https://text-clean-ai.com/ar',
        ja: 'https://text-clean-ai.com/ja',
        nl: 'https://text-clean-ai.com/nl',
        tr: 'https://text-clean-ai.com/tr',
        id: 'https://text-clean-ai.com/id',
      },
    },
    openGraph: {
      title: lang.title,
