...
export function generateLocalizedMetadata(langCode: string) {
  ...
  return {
    ...
    alternates: {
      canonical: langCode === 'en' ? 'https://text-cleaner-ai.com' : `https://text-cleaner-ai.com/${langCode}`,
      languages: {
        en: 'https://text-cleaner-ai.com',
        es: 'https://text-cleaner-ai.com/es',
        de: 'https://text-cleaner-ai.com/de',
        fr: 'https://text-cleaner-ai.com/fr',
        it: 'https://text-cleaner-ai.com/it',
        pt: 'https://text-cleaner-ai.com/pt',
        ar: 'https://text-cleaner-ai.com/ar',
        ja: 'https://text-cleaner-ai.com/ja',
        nl: 'https://text-cleaner-ai.com/nl',
        tr: 'https://text-cleaner-ai.com/tr',
        id: 'https://text-cleaner-ai.com/id',
      },
    },
    openGraph: {
      title: lang.title,
